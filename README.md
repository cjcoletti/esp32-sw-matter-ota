...
Caixa compacta para montar o **Magic Button** com **ESP32-C6 Super Mini** e mini fonte Hilink (modelo paramétrico **V16.3**).

Os arquivos CAD/STL, dimensões, layout interno, impressão e fixação estão no repositório dedicado:

**[esp32c6-supermini-enclosure](https://github.com/cjcoletti/esp32c6-supermini-enclosure)** — [README em português](https://github.com/cjcoletti/esp32c6-supermini-enclosure/blob/main/README.md) · [English README](https://github.com/cjcoletti/esp32c6-supermini-enclosure/blob/main/README.en.md)
